...
from trial.robust_strategy import CerberusFedStrategy
...
def server_fn(context: Context):
    ...
    # CSV logging for participation tracking
    class TrackingCerberusStrategy(CerberusFedStrategy):
        """Extended CerberusFedStrategy with participation logging."""
        
        def aggregate_fit(self, server_round, results, failures):
            # Track malicious client participation
            malicious_count = 0
            ...
            # Call parent CERBERUS-AGG aggregation
            return super().aggregate_fit(server_round, results, failures)

    # Get total number of clients from context
    num_clients = context.run_config.get("num-supernodes", 100)
    
    strategy = TrackingCerberusStrategy(
